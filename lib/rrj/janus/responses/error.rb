  ...
  module Janus
    module Responses
      ...
      class Errors
        ...
        def _403(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseUnauthorized,
                request.error_code,
        ...
        def _405(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseUnauthorizedPlugin,
                request.error_code,
                request.error_reason
        end
        ...
        def _450(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseTransportSpecific,
                request.error_code,
                request.error_reason
        end
        ...
        def _452(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseMissingRequest,
                request.error_code,
                request.error_reason
        end
        ...
        def _453(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseUnknownRequest,
                request.error_code,
                request.error_reason
        end
        ...
        def _454(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseInvalidJSON,
                request.error_code,
                request.error_reason
        end
        ...
        def _455(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseInvalidJSONObject,
                request.error_code,
                request.error_reason
        end
        ...
        def _456(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseMissingMandatoryElement,
                request.error_code,
                request.error_reason
        end
        ...
        def _457(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseInvalidRequestPath,
                request.error_code,
                request.error_reason
        end
        ...
        def _458(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseSessionNotFound,
                request.error_code,
                request.error_reason
        end
        ...
        def _459(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseHandleNotFound,
                request.error_code,
                request.error_reason
        end
        ...
        def _460(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponsePluginNotFound,
                request.error_code,
                request.error_reason
        end
        ...
        def _461(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponsePluginAttach,
                request.error_code,
                request.error_reason
        end
        ...
        def _462(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponsePluginMessage,
                request.error_code,
                request.error_reason
        end
        ...
        def _463(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponsePluginDetach,
                request.error_code,
                request.error_reason
        end
        ...
        def _464(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseJSEPUnknownType,
                request.error_code,
                request.error_reason
        end
        ...
        def _465(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseJSEPInvalidSDP,
                request.error_code,
                request.error_reason
        end
        ...
        def _466(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseTrickleInvalidStream,
                request.error_code,
                request.error_reason
        end
        ...
        def _476(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseInvalidElementType,
                request.error_code,
                request.error_reason
        end
        ...
        def _468(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseSessionConflit,
                request.error_code,
                request.error_reason
        end
        ...
        def _469(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseUnexpectedAnswer,
                request.error_code,
                request.error_reason
        end
        ...
        def _470(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseTokenNotFound,
                request.error_code,
                request.error_reason
        end
        ...
        def _471(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseWebRTCState,
                request.error_code,
                request.error_reason
        end
        ...
        def _472(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseNotAcceptingSession,
                request.error_code,
                request.error_reason
        end
        ...
        def _490(request)
          raise RubyRabbitmqJanus::Errors::Janus::ResponseUnknown,
                request.error_code,
                request.error_reason
        end
